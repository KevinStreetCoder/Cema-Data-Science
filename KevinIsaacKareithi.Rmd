...
# Create interactive histograms for all the data
```{R plot}
...
# Create an interactive choropleth showing the acute malnutrition in different counties
```{R map}
p <- ggplot(data_sf) +
...
# Scatter plot of average dewormed vs. average malnutrition
```{R Scatter}
